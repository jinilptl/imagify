...
const Description = () => {
  ...
  <div>
    ...
    <p className=' text-gray-600 mb-4 text-justify'>
      ...
      visuals or unique imagery, our tool transforms your text into eye-catching images with just a few clicks.
    ...
    <p className='text-gray-600 text-justify'>
      ...
      From product visuals to character designs and portraits, even concepts that don't yet exist
